...
<nav class="navbar">
  <div class="logo">
    ...
    <a href="index.php?page=home" style="text-decoration:none"><h4 class="title">Loan Management System</h4></a>
  </div>
...
<ul class="nav-sub" id="nav-open">
    ...
    <?php endif; ?>
    <li class="list-item"><a href="ajax.php?action=logout" class="nav-link nav-users"><span class='icon-field'><i class="fa fa-power-off"  style="width :30px;"></i> <span>Log Out</span><?php echo $_SESSION['login_name'] ?> </a></li>
</ul> 
